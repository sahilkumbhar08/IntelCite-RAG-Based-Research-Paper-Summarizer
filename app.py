...
API_KEY = os.getenv("GOOGLE_API_KEY", "find it from a google studio")
...
st.markdown('<h1 class="main-title">ResearchGPT</h1>', unsafe_allow_html=True)
...
with st.sidebar:
    ...
    st.markdown("### About")
    st.markdown("""
    **ResearchGPT** is an intelligent research assistant powered by advanced AI models. It helps you:
